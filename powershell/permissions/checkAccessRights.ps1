param (
	[string]$UserOrGroup = $(throw "-UserOrGroup is required."),
	[string]$WebAppUrl = $(throw "-WebAppUrl is required."),
...
Function GetUserAccessReport($WebAppURL, $SearchUser)
{
	...
	Write-host "`n Access Rights Report Generated at $($path)"
}


#Call the function to Check User Access
GetUserAccessReport $WebAppUrl $UserOrGroup